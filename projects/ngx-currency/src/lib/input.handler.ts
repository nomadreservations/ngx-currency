...
export class InputHandler {
    ...
    private onModelChange: (event: any) => any;
    private onModelTouched: (event: any) => any;
    ...
    getOnModelChange(): (event: any) => any {
        return this.onModelChange;
    }

    setOnModelChange(callbackFunction: (event: any) => any): void {
        this.onModelChange = callbackFunction;
    }

    getOnModelTouched(): (event: any) => any {
        return this.onModelTouched;
    }

    setOnModelTouched(callbackFunction: (event: any) => any) {
